...
This is hardware-dependent and assumes MKL libraries for BLAS/LAPACK installed. Omit in case necessary and make `cores` equal to the number of cores in your machine you want to use.
...
mod1 <- gam( logpm2 ~   SUBREGION + ROOMNUMBER +
                HASLIFT + HASGARDEN + HASSWMMINGPOOL + HASTERRACE + IND_GARAJE +
